set moduleName object_detect_nnbw_Pipeline_1
set isTopModule 0
...
set cdfgNum 7
set C_modelName {object_detect_nnbw_Pipeline_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_input { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 16 regular {axi_master 0}  }
	{ p_cast_cast int 63 regular  }
	{ local_input int 16 regular {array 1024 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "p_cast_cast", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "local_input", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ p_cast_cast sc_in sc_lv 63 signal 1 } 
	...
	{ local_input_d0 sc_out sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_input_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "local_input", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	local_input { ap_memory {  { local_input_address0 mem_address 1 10 }  { local_input_ce0 mem_ce 1 1 }  { local_input_we0 mem_we 1 1 }  { local_input_d0 mem_din 1 16 } } }
