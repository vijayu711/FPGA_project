...
$(ObjDir)/tb_nn.o: ../../../../../tb_nn.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb_nn.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_nn.d

$(ObjDir)/nn.o: ../../../../../nn.cpp $(ObjDir)/.dir csim.mk
