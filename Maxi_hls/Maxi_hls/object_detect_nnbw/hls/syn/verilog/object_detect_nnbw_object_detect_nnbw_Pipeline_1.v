...
module object_detect_nnbw_object_detect_nnbw_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond18_fu_113_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    gmem_blk_n_R;
wire    ap_block_pp0_stage0_grp1;
reg   [10:0] loop_index135_load_reg_135;
reg    ap_block_pp0_stage0_11001;
reg   [15:0] gmem_addr_read_reg_140;
reg    ap_block_pp0_stage0_11001_grp1;
wire   [63:0] loop_index135_cast_fu_124_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [10:0] loop_index135_fu_50;
wire   [10:0] empty_fu_103_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_loop_index135_load;
...
always @ (*) begin
    if (((exitcond18_fu_113_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index135_load = 11'd0;
    end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem_0_RVALID == 1'b0) & (ap_start_int == 1'b1));
end

assign ap_block_pp0_stage0_11001_grp0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem_0_RVALID == 1'b0) & (ap_start_int == 1'b1));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem_0_RVALID == 1'b0) & (ap_start_int == 1'b1));
end
...
assign empty_fu_103_p2 = (ap_sig_allocacmp_loop_index135_load + 11'd1);

assign exitcond18_fu_113_p2 = ((p_cast7_fu_109_p1 == length_r) ? 1'b1 : 1'b0);

assign local_input_address0 = loop_index135_cast_fu_124_p1;

assign local_input_ce0 = local_input_ce0_local;

assign local_input_d0 = gmem_addr_read_reg_140;

assign local_input_we0 = local_input_we0_local;

assign loop_index135_cast_fu_124_p1 = loop_index135_load_reg_135;
...
assign p_cast7_fu_109_p1 = empty_fu_103_p2;

endmodule //object_detect_nnbw_object_detect_nnbw_Pipeline_1
