...
HD_PWD='E:/Vivado/project_Maxi/project_Maxi.runs/design_1_object_detect_nnbw_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_object_detect_nnbw_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_object_detect_nnbw_0_0.tcl
