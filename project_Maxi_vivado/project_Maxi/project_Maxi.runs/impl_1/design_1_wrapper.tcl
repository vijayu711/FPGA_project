namespace eval ::optrace {
  variable script "E:/Vivado/project_Maxi/project_Maxi.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/vuppalapati2024/AppData/Roaming/Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/Vivado/project_Maxi/project_Maxi.cache/wt [current_project]
  set_property parent.project_path E:/Vivado/project_Maxi/project_Maxi.xpr [current_project]
  set_property ip_repo_paths {{E:/New folder/object_detect_nnbw}} [current_project]
  update_ip_catalog
  set_property ip_output_repo E:/Vivado/project_Maxi/project_Maxi.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/Vivado/project_Maxi/project_Maxi.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/Vivado/project_Maxi/project_Maxi.srcs/sources_1/bd/design_1/design_1.bd
